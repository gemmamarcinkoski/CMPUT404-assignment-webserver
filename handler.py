...
class HTTPResponse:
    ...
    def MakeResponse(self):
        ...
        return header + "\r\n" + "418: i'm a teapot, i haven't handled this case \r\n"
    ...
    def timeHeader(self, timestamp=None):
        weekdayName = ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"]
        
        monthName = [None, "January", "February", "March", "April", "May", "June", "July", "August",
        ...
        date_header = "%s, %02d %3s %4d %02d:%02d:%02d GMT" % (weekdayName[weekday], day, monthName[month], year, hour,minute, seconds)
